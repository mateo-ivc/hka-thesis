...
#acr("NTP") stellt das Standardverfahren für die allgemeine Systemzeitsynchronisation im IT-Bereich dar@rfc5905[1]. Es ist darauf ausgelegt, Latenzschwankungen und einzelne unzuverlässige Messungen im Internet oder in Weitverkehrsnetzen statistisch auszugleichen @rfc5905[10] @rfc5905[11.2.1]. Toleriert dennoch Abweichungen im Millisekundenbereich@ieee8021as2025[C.3]. Für Anwendungen in der industriellen Automatisierung oder im Automobilbereich sind jedoch Genauigkeiten im Nanosekundenbereich immer häufiger von großer Bedeutung@ti_spry316.
