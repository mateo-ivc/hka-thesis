...
Neben diesen beiden Anforderungen fordert @ieee8021as2025[B.2.4] außerderm den Nachweis, dass die interne Synchronisierung zwischen Master und Slave eine Genauigkeit von 0,1 #acr-emph("ppm") erreicht. Um dies nachzuweisen, wir wie folgt vorgegangen:
...
Liegt die berechnete Standardabweichung $sigma$ innerhalb der geforderten 0,1 #acr("ppm"), gilt die Anforderung an die interne Synchronisierung als erfüllt.
